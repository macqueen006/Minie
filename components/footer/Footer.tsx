...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden bg-navy-blue">
      ...
      <div className="relative z-10">
        <div className="w-full max-w-5xl px-4 xl:px-0 py-10 lg:pt-16 mx-auto">
          <div className="inline-flex items-center">
            {/* Logo  */}
              <a href="#" className="font-bold text-white">Minie</a>
            {/* End Logo  */}
            <div className="border-s border-neutral-700 ps-5 ms-5">
              <p className="text-sm text-neutral-400">2024 Minimal Co.</p>
            </div>
          </div>
        </div>
      </div>
