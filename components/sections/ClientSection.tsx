...
import Fullview from "@/public/svg/Fullview.svg";
import Xevo from "@/public/svg/Xevo.svg";
import OpenAi from "@/public/svg/OpenAi.svg";
import Ledger from "@/public/svg/Ledger.svg";

const ClientSection = () => {
  return (
    <div className="relative overflow-hidden pt-4 bg-navy-blue">
      <svg
      ...
      <div className="relative z-10">
        <div className="max-w-5xl px-4 xl:px-0 mx-auto">
          ...
          <div className="flex justify-between gap-6">
            <Fullview className="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-neutral-400" />
            <Xevo className="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-neutral-400" />
            <OpenAi className="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-neutral-400" />
            <Ledger className="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-neutral-400" />
          </div>
        </div>
      </div>
    </div>
