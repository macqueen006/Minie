      ...
      <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
          <div className="aspect-w-16 aspect-h-9 lg:aspect-none">
            <img className="w-full object-cover rounded-xl" src="https://images.unsplash.com/photo-1612198273689-b437f53152ca?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTMyfHxzdG9jayUyMG1hcmtldHxlbnwwfHwwfHx8MA%3D%3D" alt="Image Description" />
          </div>
           {/* End Col  */}
          ...
          <div>
            ...
            <div className="flex gap-x-5 ms-1">
               {/* Icon  */}
              <div className="relative last:after:hidden after:absolute after:top-8 after:bottom-0 after:start-4 after:w-px after:-translate-x-[0.5px] after:bg-light-blue">
